 ...
 */
var app = angular.module('emergencyphones',["ngMaterial", "firebase"]);

function emergencyphones($scope, $firebaseArray) {
    ...
    var ref = firebase.database().ref().child("emegrencyphones");
    $scope.messages = $firebaseArray(ref);

    $scope.addMessage = function() {
        $scope.messages.$add({
            name: $scope.AddName,
            fulltel:$scope.AddFullNumber,
            tel: $scope.AddNumber,
            type: $scope.type
        });
        $scope.AddFullNumber = '';
...
app.component('emergencyPhones',{
    templateUrl: './emergencyPhones/emergencyphones.html',
